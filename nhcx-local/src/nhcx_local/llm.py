...
DEFAULT_MODEL = os.getenv("NHCX_MODEL", "gemma3:27b")


def get_llm(model: str = None, temperature: float = 0.7, max_tokens: int = 8192):
    """
    Return a LangChain ChatOllama instance for local inference.

    Args:
        model:       Ollama model name (e.g. "gemma3", "llama3.1:8b").
                     Defaults to NHCX_MODEL env var or "gemma3".
